...
//		pInconel->i_MaterialType = __ELASTIC;
	...
	glm::dvec3 d3Center_Array			= glm::dvec3(0.5*dDiameter_Outer + 2.0*d3_Length_Cell.x-dOffset, 0.5*dDiameter_Outer+1.0*d3_Length_Cell.y-0.0*dOffset,0.5*d3_Length_Grid.z);
