...
// ----------------------------------------------------------------------------
std::vector<MaterialPoint_BC *> MaterialPoint_Factory_Classic_CC::createDomain_AuxeticMesh(glm::dvec3 d3Origin, glm::ivec2 i2Array, glm::dvec3 d3Dimension, double dOffset)
{
	...
	for(int index_x = 0; index_x < i2Array.x; index_x++)
	{
		for(int index_y = 0; index_y < i2Array.y; index_y++)
		{
			...
			std::vector<MaterialPoint_BC *> thisCell = createDomain_AuxeticCell(thisCell_Center, d3Dimension, dOffset);
