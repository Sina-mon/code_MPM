...
void PhysicsEngine::initializeWorld_CPDI_HalfRing_Xiang_PlainStrain(void)
{
	...
	// ------------------------------------------------------------------------
	// grid points ------------------------------------------------------------
	glm::dvec3 d3_Length_Grid = glm::dvec3(0.040, 0.070, 0.002);
	glm::ivec3 i3_Cells = 1*glm::ivec3(40, 70, 2);
...
//			v_MarkedMaterialPoints_Stress_Monitor.push_back(thisMP);
	...
	{// top platen material points -------------------------------------------- platen MP
		glm::dvec3 d3Dimension = glm::dvec3(0.9*d3_Length_World.x,8.0*d3_Length_Cell.y,d3_Length_World.z);
		...
		{// assign material point initial values
			...
			thisMP->d_ElasticModulus = 300.0e9;
			thisMP->d_Viscosity = 0.0;
			thisMP->d_PoissonRatio = 0.3;
